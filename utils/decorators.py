...
class IconicDecorator(object):
    def __init__(self):
        self.PASS = Style.BRIGHT + Fore.BLUE + "[ ✔ ]" + Style.RESET_ALL
        ...
        self.CMDL = Style.BRIGHT + Fore.GREEN + "[ → ]" + Style.RESET_ALL
        self.STDS = "     "


class StatusDecorator(object):
    def __init__(self):
        self.PASS = Style.BRIGHT + Fore.BLUE + "[ SUCCESS ]" + Style.RESET_ALL
        ...
        self.CMDL = Style.BRIGHT + Fore.GREEN + "[ COMMAND ]" + Style.RESET_ALL
        self.STDS = "           "
